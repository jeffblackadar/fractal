...
fractal_l_generate = R6Class(
  ...
  public = list(
    ...
    initialize = function(start_x = 0,
      ...
      #print("self$generation_current:")
      #print(self$generation_current)
      #print(self$generator_number)
      ...
      #print(self$line_colors[1])
      #print(generation_line_color)

      #print(fractal_instruction_line)
      
      for (i in 1:nchar(fractal_instruction_line)) {
        fractal_instruction_char <- substr(fractal_instruction_line, i, i)
        # print(paste0(
        #   fractal_instruction_char,
        #   " of ",
        #   fractal_instruction_line,
        #   '  i=',
        #   i
        # ))
        ...
        if (fractal_instruction_char == 'F' |
          ...
          if (self$generation_current == self$generation_max) {
            ...
            #   startX, startY, ignore = make_l_system_gen(canvas, startX, startY, current_angle, current_branch_length, branch_width, branch_fill, l_type, l_F_generator, l_f_generator, l_F_generator, l_angle, current_generation, max_generation)
          ...
          if (fractal_instruction_char == 'f') {
            if (self$generation_current == self$generation_max) {
              #   startX, startY = moveVector(startX, startY, current_angle, current_branch_length)
...
#ggplot(self$fractal_lines, aes(x, y, group = id, color = line_color)) +
#geom_line(size= self$fractal_lines$line_width) +
